...
//
//public class KacauRegisterActivity extends AppCompatActivity implements View.OnClickListener {
//
...
//                    Toast.makeText(KacauRegisterActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
//                    Intent intentRegister = new Intent(KacauRegisterActivity.this, LoginActivity.class );
...
//                Toast.makeText(KacauRegisterActivity.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
//
//            }
//        });
//
